...
INSERT INTO linkis_config_key (id, `key`, description, name, application_id, default_value, validate_type, validate_range, is_hidden, is_advanced, level) VALUES (0, 'wds.linkis.spark.dynamic.enabled', '取值范围：1 true/0 false', '是否开启Spark动态资源分配', 3, '0', 'NumInterval', '[0,1]', 1, 0, 1);
INSERT INTO `linkis_config_key` (`id`, `key`, description, name, application_id, default_value, validate_type, validate_range, is_hidden, is_advanced, level) VALUES (0, 'spark.dynamicAllocation.initialExecutors', '取值范围：1-10，单位：个', '初始执行器个数', 3, '0', 'NumInterval', '[0,10]', 0, 1, 2);
INSERT INTO linkis_config_key (id, `key`, description, name, application_id, default_value, validate_type, validate_range, is_hidden, is_advanced, level) VALUES (0, 'spark.dynamicAllocation.minExecutors', '取值范围：1-10，单位：个', '最小执行器个数', 3, '0', 'NumInterval', '[0,10]', 0, 1, 2);
